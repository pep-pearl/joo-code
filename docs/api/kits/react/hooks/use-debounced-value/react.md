...
[Joo Code Archive API](../../../../modules.md) / kits/react/hooks/use-debounced-value/react
...
Defined in: kits/react/hooks/use-debounced-value/react/index.ts:30
...
debounce를 적용할 원본 값입니다.

##### delay

`number` = `250`

지연 시간입니다. 단위는 밀리초이며 기본값은 `250`입니다.

#### Returns

`T`

지연 시간이 지난 뒤 반영된 마지막 값입니다.
