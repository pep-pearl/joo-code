...
| [`browser/viewport`](_media/README-1.md) | 모바일 브라우저 viewport 높이 보정이 필요할 때 | `kits/browser/viewport/` |
| [`react/hooks/use-debounced-value`](_media/README-2.md) | 빠르게 바뀌는 값을 지연 반영하는 React hook이 필요할 때 | `kits/react/hooks/use-debounced-value/` |
...
TypeDoc 문서는 보조 자료이며 [`docs/api`](_media/README-3.md)에 생성됩니다.
