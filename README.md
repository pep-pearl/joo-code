...
1. [`docs/archive-map.md`](docs/archive-map.md)에서 필요한 문제 영역을 찾습니다.
2. 각 kit의 `README.md`에서 복사 범위와 의존성을 확인합니다.
3. 필요한 폴더를 프로젝트로 복사합니다.

기존 경로에서 새 위치를 찾는 경우 [`docs/migration.md`](docs/migration.md)를 확인합니다.
...
자세한 기준은 [`docs/unit-grades.md`](docs/unit-grades.md)를 확인합니다.
...
TypeDoc 문서는 보조 자료이며 [`docs/api`](docs/api/README.md)에 생성됩니다.
